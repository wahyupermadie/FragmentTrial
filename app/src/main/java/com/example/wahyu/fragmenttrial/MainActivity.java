package com.example.wahyu.fragmenttrial;
...
import com.example.wahyu.fragmenttrial.adapter.TabFragmentPageAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pager.setAdapter(new TabFragmentPageAdapter(getSupportFragmentManager()));
